/*
Here the vidly genre code from last project is copied. Bute two custom middlewares log and auth are used.
*/
const express = require("express");
const Joi = require("joi");
const app = express();
const logger = require("./logger"); // custom middleware
const authenticator = require("./authenticate"); //custom middleware
app.use(express.json()); // json middleware, passes control to logger
app.use(logger); // custom middleware, passes function to auth,
app.use(authenticator); // passes function to route()
/* If you perform a any CRUD operation and check the console you will see the ordering, 
first logging then autheticate */
// Resourse in DB
const genres = [
